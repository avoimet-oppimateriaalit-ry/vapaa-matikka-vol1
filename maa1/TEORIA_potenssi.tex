\qrlinkki{http://opetus.tv/maa/maa1/potenssi-ja-sen-laskusaannot/}
{Opetus.tv: \emph{Potenssi ja sen laskusäännöt} ($2.55$, $7.09$, $3.41$, $4.34$, $2.13$, $5.10$ ja $5.14$)}
...
§ $xxx\cdot x=x\cdot x \cdot x \cdot x =x^4$ (kertolaskun merkintä ja potenssin määritelmä)
...
\alakohdat{
§ $(-2)^4 = -2 \cdot (-2)\cdot(-2)\cdot(-2) = 16$
§ Merkinnässä $-2^4$ potenssin kantaluku on $2$. Koska $2^4 = 16$, $-2^4=-16$. Kerralla laskettuna: $-2^4 =-(2^4)= -(2 \cdot 2\cdot 2 \cdot 2) = -16$
}
\end{esimerkki}
...
§ $\left(\frac{5}{7}\right)^{-1}=\frac{7}{5}$ (vrt. edellinen kohta)
