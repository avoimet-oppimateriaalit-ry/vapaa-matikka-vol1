\qrlinkki{http://opetus.tv/mab/mab1/prosentit/}
{Opetus.tv: \emph{Prosentit} ($5.38$ ja $4.06$)}
...
%\begin{esimerkki}
%Vuonna 2000 täysi-ikäisiä Suomen kansalaisia oli..., joista Väestörekisterikeskuksen tietojen mukaan .... oli naisia ja ... miehiä. Kansanterveystilastoista käy ilmi, että kyseisenä vuonna $5,6$\,\% aikuisista miehistä ja $3,4$\,\% aikuisista naisista oli käyttänyt elinaikanaan lääkkeitä päihdetarkoituksessa. Kuinka monta prosenttia aikuisista kaiken kaikkiaan oli käyttänyt elinaikanaan lääkkeitä päihdetarkoituksessa vuonna 2000?
%	\begin{esimratk}
%	
%	\end{esimratk}
%	\begin{esimvast}
...
%\begin{tehtävä}
%Heroiinin käyttäjistä $90\,\%$ on vähintään kokeillut kannabista, ja kannabiksen käyttäjistä __ on vähintään kokeillut heroiinia. Kuinka heroiinin käyttäjä ei ole kokeillut kannabista, kuinka moni kannabiksen käyttäjä ei ole kokeillut heroiinia? Kumman käyttäjiä on enemmän? Huomaa, että pelkästään näillä tiedoilla ei voida sanoa, kuinka suuri osa kaikista ihmisistä on kokeillut kumpaakaan huumetta.
%	\begin{vastaus}
%	
%	\end{vastaus}
%\end{tehtävä}
...
%}
	...
	%\alakohdat{
%§
$V=a^3$ on alkuperäinen tilavuus. Korvataan nyt (jokainen) $a$ kasvaneella versiolla $1,05a$, jolloin saadaan lauseke $(1,05a)^3$. Tästä saadaan tulon potenssina $1,05^3a^3 \approx 1,158a^3$. Vertaamalla alkuperäiseen tilavuuteen $a^3$ todetaan, että tilavuus on kasvanut noin $15,8$ prosenttia. %tarkista vastaustarkkuus prosentuaalisissa muutoksissa
%§
%}
	\end{esimratk}
