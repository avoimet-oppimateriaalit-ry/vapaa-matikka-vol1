...
\alakohdat{
    ...
    § Meijun kuukausipalkka on $1\,623,52$ euroa. Hän saa $1,3\,\%$ palkankorotuksen. Mikä on kuukausipalkka korotuksen jälkeen?
    }
    \begin{vastaus}
    \alakohdat{
    § $168,75$ euroa
...
\begin{tehtava}
    ...
    \alakohdat{
        § Kuinka monta prosenttia Samulin pituus on Annikan pituudesta?
        § Kuinka monta prosenttia Annikan pituus on Samulin pituudesta?
        § Kuinka monta prosenttia Samuli on lyhyempi kuin Annika?
        § Kuinka monta prosenttia Annika on pidempi kuin Samuli?
    }
    \begin{vastaus}
        \alakohdat{
            § $95,4\,\%$
...
Miksi ei kannata mennä ostoksille kauppaan, joka mainostaa liikkeessä olevan ''$-40$\,\%:n alennus''?
	\begin{vastaus}
	Pelkkä ''$40$ prosentin alennus'' tarkoittaa, että hinnat on kerrottu prosenttikertoimella $1-\frac{40}{100}=0,6$. Jos kyseessä on negatiivinen alennus, prosenttikerroin on $1-\frac{-40}{100}=1+\frac{40}{100}=1,4$, eli hintoja on kasvatettu.
	\end{vastaus}
\end{tehtava}
...
% jonnekin tehtävään toisaalta poistettu "ilman ongelmia tai todistuksen yleisyyden heikentymistä (''\textit{without loss of generality}'', \textit{WLOG})"
