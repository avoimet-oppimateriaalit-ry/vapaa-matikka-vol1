...
Laske.
\alakohdat{
§ $1,21\,\mathrm{\frac{mg}{ml}}\cdot 2,00\,\mathrm{ml}=1,21\cdot 2,00\cdot\mathrm{\frac{mg}{ml}}\cdot \mathrm{ml}=2,42\cdot \mathrm{\frac{mg\cdot \mathrm{ml}}{ml}}=2,42\,\mathrm{mg}$
...
§ $234\,\mathrm{\frac{kg}{dm^3}}\,0,10\,\mathrm{m^3}=234\cdot0,10\cdot \mathrm{\frac{kg}{dm^3}}\cdot \mathrm{m^3}=23,4\,\mathrm{\frac{kg\,m^3}{(dm)^3}}=23,4\,\mathrm{\frac{kg\,m^3}{(10^{-1}\,m)^3}}=23,4\, \mathrm{\frac{kg\,m^3}{(10^{-1})^3\,m^3}}=23,4\,\mathrm{\frac{kg\,m^3}{10^{-3}\,m^3}}=23,4\,\mathrm{\frac{kg}{10^{-3}}}=23,4\cdot10^3\,\mathrm{kg}=23\,400\,kg\approx23\,000\,kg$
}
\end{esimerkki}
