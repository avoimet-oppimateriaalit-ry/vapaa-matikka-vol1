...
\lukufilter{#1}{\input{maa1/LIITE_lahtotasotesti}}

\newpage

\chapter*{MAA1 Funktiot ja yhtälöt}
\addcontentsline{toc}{chapter}{MAA1 Funktiot ja yhtälöt}
\lukufilter{#1}{\input{maa1/LIITE_esipuhe}}
...
\chapter*{MAA2 Polynomifunktiot}
\addcontentsline{toc}{chapter}{MAA2 Polynomifunktiot}
\lukufilter{#1}{\input{maa2/LIITE_esipuhe}}
