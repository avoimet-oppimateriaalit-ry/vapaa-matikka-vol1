...
\laatikko[Polynomien jakolause]{Jos $x=b$ on polynomin nollakohta, $x-b$ on polynomin tekijä.}
...
Jaetaan tekijöihin $P(x)=2x^2 + 4x-30$.
	\begin{esimratk}
Ratkaistaan nollakohdat yhtälöstä $$2x^2 + 4x-30=0$$ toisen asteen yhtälön ratkaisukaavalla. Nollakohdat ovat $x_1=3$ ja $x_2=-5$. Saadaan siis
$$P(x)= 2(x-3)(x-(-5)) = 2(x-3)(x+5).$$
	\end{esimratk}
\end{esimerkki}

\begin{esimerkki}
Toisen asteen polynomin $P$ nollakohdat ovat $x=1$ ja $x=3$. Lisäksi $P(2)=3$. Määritä $P(x)$.
\begin{esimratk}
...
\begin{esimerkki}
Polynomia $x^2+4$ ei voi jakaa reaalisiin ensimmäisen asteen tekijöihin. (Algebrallisten ja numeeristen menetelmien jatkokurssin kompleksiluvuila tämä kyllä onnistuu).
\end{esimerkki}